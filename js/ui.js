...
Portfolio.ui = (function () {
  ...
  function _renderStatement() {
    ...
    section.innerHTML = `
      <div class="statement-inner">
        ...
        <h1 class="statement-title">${_esc(data.title)}</h1>
  ...
  function _renderContact() {
    ...
    section.innerHTML = `
      <div class="contact-inner">
        ...
        <p class="contact-intro">${_esc(data.inquiries)}</p>

        <div class="contact-links">
          <div class="contact-link-item">
            <span class="contact-link-label">Email</span>
            <a class="contact-link-value" href="mailto:${_esc(data.email)}">${_esc(data.email)}</a>
          </div>
          <div class="contact-link-item">
            <span class="contact-link-label">Instagram</span>
            <span class="contact-link-value">${_esc(data.instagram)}</span>
          </div>
          <div class="contact-link-item">
            <span class="contact-link-label">Representation</span>
            <span class="contact-link-value">${_esc(data.representation)}</span>
          </div>
        </div>
      </div>
    `;
  ...
  function init() {
    ...
    document.addEventListener('portfolio:navigate', e => {
      ...
      if (e.detail.section === 'statement') _renderStatement();
      if (e.detail.section === 'contact') _renderContact();
    });
  }
