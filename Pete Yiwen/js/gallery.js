...
Portfolio.gallery = (function () {
  ...
  function _render() {
    ...
    /* Add artwork button (edit mode) */
    const addCard = document.createElement('button');
    addCard.className = 'add-artwork-card';
    addCard.setAttribute('aria-label', 'Add new artwork');
    addCard.innerHTML = `
    ...
    `;
    addCard.addEventListener('click', () => Portfolio.edit.promptAddArtwork());
